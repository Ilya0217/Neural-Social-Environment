...
const DEFAULT_ROLES = [
  'Исследователь', 'Критик', 'Организатор', 'Аналитик', 'Генератор идей',
  'Учёный', 'Менеджер', 'Дизайнер', 'Разработчик', 'Эксперт',
  'Лидер', 'Изобретатель', 'Наставник', 'Координатор', 'Специалист',
  'Инженер', 'Практик', 'Советник', 'Консультант', 'Помощник'
];
